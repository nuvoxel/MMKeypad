...
#define LV_COLOR_DEPTH 32   /* render in 32-bit (smooth alpha compositing over
                             * album art); bsp_linux.c dithers down to the
                             * RGB565 panel in the flush -- avoids the "edge
                             * detect" crush translucent scrims got at 16-bit. */
...
#define LV_FONT_MONTSERRAT_16 1  /* WiFi onboarding (wifi_setup.c) */
#define LV_FONT_MONTSERRAT_18 0
#define LV_FONT_MONTSERRAT_20 1  /* WiFi onboarding (wifi_setup.c) */
#define LV_FONT_MONTSERRAT_22 0
#define LV_FONT_MONTSERRAT_24 0
#define LV_FONT_MONTSERRAT_26 0
#define LV_FONT_MONTSERRAT_28 1  /* WiFi onboarding (wifi_setup.c) */
...
#define LV_USE_TINY_TTF 1   /* resolution-aware font scaling (ui.c ui_apply_font_scale) */
#if LV_USE_TINY_TTF
